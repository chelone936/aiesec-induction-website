"use client"
import { CalendarDays, UserCheck, ChevronDown, ChevronUp, Download, Share2, Copy } from "lucide-react"
...
export default function HomePage() {
  ...
  // Social Media Template Components
  const SocialMediaTemplate1 = ({ customText }: { customText?: string }) => (
    <div className="w-[300px] h-[300px] mx-auto bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl p-6 text-white relative overflow-hidden">
      <div className="absolute inset-0">
        ...
        >
          <path
            d="
              M-100 200
              C-50 100, 50 300, 100 200
              C150 100, 250 300, 300 200
              C350 100, 450 300, 500 200
            "
            stroke="white"
            strokeWidth="40"
            fill="none"
      ...
      <div className="relative z-10 h-full flex flex-col">
        <div className="flex items-center space-x-3 mb-4">
          <img
            src="/user-profile-professional.jpg"
            alt="User Profile"
            className="w-12 h-12 rounded-full object-cover border-2 border-white"
          />
          <div>
            <div className="text-sm font-bold">@yourhandle</div>
            <div className="text-xs opacity-80">AIESEC YSF Participant</div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2 mb-4">
          ...
          <span className="font-bold text-sm">AIESEC YSF</span>
        </div>

        <h2 className="text-lg font-bold mb-3 flex-1">
          {customText || "I'm attending Ethiopia's Premier Youth Leadership Forum!"}
        </h2>

        <div className="space-y-1 mb-4">
          <div className="flex items-center space-x-2">
            <CalendarDays className="w-3 h-3" />
            <span className="text-xs">15-17 Oct 2025</span>
          </div>
          <div className="flex items-center space-x-2">
        ...
        <div className="bg-white/20 rounded-lg p-3 mb-3">
          <div className="grid grid-cols-2 gap-3 text-center">
            <div>
              <div className="text-lg font-bold">1600</div>
        ...
        <div className="text-center">
          <span className="text-xs font-medium">#AIESECYSF2025 #YouthLeadership</span>
        </div>
      </div>
    </div>
  )

  const SocialMediaTemplate2 = ({ customText }: { customText?: string }) => (
    <div className="w-[300px] h-[300px] mx-auto bg-black rounded-2xl p-6 text-white relative overflow-hidden">
      <div className="absolute inset-0">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400" className="w-full h-full opacity-10">
          <path
            d="
              M-100 200
              C-50 100, 50 300, 100 200
      ...
      <div className="relative z-10 h-full flex flex-col">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            <div className="text-sm font-bold">@yourhandle</div>
            <div className="text-xs opacity-80">Future Leader</div>
          </div>
        </div>

        <div className="text-center mb-4">
          <h1 className="text-2xl font-bold mb-1">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-orange-400">YSF</span>
          </h1>
          <p className="text-xs opacity-80">AIESEC YOUTH SKILLS FORUM</p>
        </div>

        <div className="text-center mb-4 flex-1">
          <h2 className="text-lg font-bold mb-2">{customText || "I'm ready to become a FUTURE LEADER"}</h2>
          <p className="text-xs opacity-80">15-17 October 2025</p>
          <p className="text-xs opacity-80">Addis Ababa, Ethiopia</p>
        </div>

        <div className="bg-white/10 rounded-lg p-3 mb-3 backdrop-blur-sm">
          <div className="text-center">
            <div className="text-2xl font-bold text-orange-400 mb-1">{String(timeLeft.days).padStart(2, "0")}</div>
            <div className="text-xs opacity-80">DAYS TO GO</div>
          </div>
        </div>

        <div className="text-center">
          <span className="text-xs font-medium opacity-80">#AIESECYSF #Leadership #Ethiopia</span>
        </div>
      </div>
    </div>
  )

  const SocialMediaTemplate3 = ({ customText }: { customText?: string }) => (
    <div className="w-[300px] h-[300px] mx-auto bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl p-6 text-white relative overflow-hidden">
      <div className="absolute inset-0">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 400 400"
      ...
      <div className="relative z-10 h-full flex flex-col">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            <div className="text-sm font-bold">@yourhandle</div>
            <div className="text-xs opacity-80">Changemaker</div>
          </div>
        </div>

        <div className="mb-4 flex-1">
          <h1 className="text-2xl font-bold mb-1">I'M JOINING</h1>
          <h2 className="text-2xl font-bold mb-3">ETHIOPIA'S YOUTH HUB</h2>
          <p className="text-sm font-medium">{customText || "Ready to lead the future!"}</p>
        </div>
        ...
        <div className="bg-black/20 rounded-lg p-3 mb-4 backdrop-blur-sm">
          <div className="flex justify-between items-center text-xs">
            <div>
              ...
              <div className="font-bold">15-17 OCT</div>
            </div>
            <div>
              <div className="opacity-80">VENUE</div>
              <div className="font-bold">ADDIS ABABA</div>
            </div>
            <div>
              <div className="opacity-80">EDITION</div>
        ...
        <div className="text-center">
          <div className="text-xs font-medium mb-1">SEE YOU THERE!</div>
          <div className="text-xs opacity-80">#AIESECYSF2025 #YouthEmpowerment</div>
        </div>
      </div>
    </div>
  )

  const SocialMediaTemplate4 = ({ customText }: { customText?: string }) => (
    <div className="w-[300px] h-[300px] mx-auto bg-white rounded-2xl p-6 text-black relative overflow-hidden border-4 border-blue-600">
      <div className="absolute inset-0">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 400 400"
      ...
      <div className="relative z-10 h-full flex flex-col">
        <div className="flex items-center space-x-3 mb-4">
          ...
          />
          <div>
            <div className="text-sm font-bold text-blue-600">@yourhandle</div>
        ...
        <div className="text-center mb-4">
          ...
          <h1 className="text-lg font-bold text-blue-600 mb-1">AIESEC YSF</h1>
          <p className="text-xs text-gray-600">Youth Skills Forum 2025</p>
        </div>

        <div className="text-center mb-4 flex-1">
          <h2 className="text-lg font-bold mb-3">{customText || "I'm ready to Network. Learn. Lead."}</h2>
        ...
        <div className="bg-gray-100 rounded-lg p-3 text-center mb-3">
          <div className="text-sm font-medium text-gray-800 mb-1">15-17 October 2025</div>
          <div className="text-xs text-gray-600">Addis Ababa, Ethiopia</div>
        </div>

        <div className="text-center">
          <span className="text-xs font-medium text-blue-600">#AIESECYSF2025 #NetworkingEvent</span>
        </div>
      </div>
    </div>
  )

  const SocialMediaTemplate5 = ({ customText }: { customText?: string }) => (
    <div className="w-[300px] h-[300px] mx-auto bg-black rounded-2xl p-6 text-white relative overflow-hidden">
      <div className="absolute inset-0">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <path
            d="
              M-100 200
              C-50 50, 50 350, 100 200
              C150 50, 250 350, 300 200
              C350 50, 450 350, 500 200
            "
            stroke="#1173d4ff"
            strokeWidth="60"
            fill="none"
      ...
      <div className="relative z-10 h-full flex flex-col">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            <div className="text-sm font-bold">@yourhandle</div>
            <div className="text-xs opacity-80">Youth Leader</div>
          </div>
        </div>

        <div className="text-center mb-6 flex-1">
          <h1 className="text-3xl font-bold mb-2 text-white">I'M IN!</h1>
          <h2 className="text-lg font-bold mb-4 text-blue-400">AIESEC YSF 2025</h2>
          <p className="text-sm mb-4">{customText || "Ready to connect with 1600+ future leaders in Addis Ababa!"}</p>

          <div className="bg-white/10 rounded-lg p-3 mb-4 backdrop-blur-sm">
            <div className="text-center">
              <div className="text-xl font-bold text-blue-400 mb-1">15-17 OCT</div>
              <div className="text-xs opacity-80">ADDIS ABABA, ETHIOPIA</div>
            </div>
          </div>
        </div>

        <div className="text-center">
          <span className="text-xs font-medium opacity-80">#AIESECYSF2025 #YouthLeadership #Ethiopia</span>
        </div>
      </div>
    </div>
  )
  ...
  const handleDownloadTemplate = async (templateId: string) => {
    try {
      ...
      const templateElement = document.querySelector(`[data-template="${templateId}"]`) as HTMLElement
      if (!templateElement) {
      ...
      // Create a temporary container with 1080x1080 dimensions
      ...
      // Scale up the template to fit 1080x1080
      clonedTemplate.style.transform = "scale(3.6)" // Scale from 300px to 1080px
      clonedTemplate.style.transformOrigin = "center center"
      ...
      link.download = `aiesec-ysf-2025-${templateId}.png`
      link.href = canvas.toDataURL("image/png", 1.0)
      link.click()

      // Show success message
      alert("Template downloaded successfully as 1080x1080 PNG!")
    } catch (error) {
  ...
  const handleShareTemplate = (templateId: string, platform: string) => {
    // In a real implementation, this would share to the specified platform
    console.log(`Sharing template ${templateId} to ${platform}`)
  }

  const handleCopyTemplate = (templateId: string) => {
    // In a real implementation, this would copy the template or its URL
    ...
    <div className="min-h-screen bg-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-black mb-4">
              Share Your
              <span className="text-blue-600"> Excitement</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Download and customize these 1080x1080 social media templates to share your participation in AIESEC YSF
              2025 with your network. Perfect for Instagram, Facebook, and LinkedIn posts.
            </p>
          </div>

          {/* Custom Text Input */}
          <div className="max-w-md mx-auto mb-8">
            <label className="block text-sm font-medium text-gray-700 mb-2">Customize Your Message (Optional)</label>
            <input
              type="text"
              value={customText}
            ...
            <p className="text-xs text-gray-500 mt-1">
              Templates are designed for 1080x1080 format. Your profile image placeholder can be replaced with your
              actual photo.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8 mb-12">
            {/* Template 5 */}
            <div className="group">
              <div className="mb-4" data-template="template5">
                <SocialMediaTemplate5 customText={customText} />
              </div>
              <div className="flex justify-center space-x-2">
                <button
                  onClick={() => handleDownloadTemplate("template5")}
                ...
                <button
                  onClick={() => handleShareTemplate("template5", "linkedin")}
                ...
                <button
                  onClick={() => handleCopyTemplate("template5")}
          ...
          <div className="max-w-4xl mx-auto bg-gray-50 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-black mb-6 text-center">How to Use These Templates</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-white font-bold">1</span>
                </div>
                <h4 className="font-bold text-lg mb-2">Customize</h4>
                <p className="text-gray-600">Add your personal message or use the default text</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Click download to save the template to your device</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-600">Post on your social media platforms and tag us!</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex animate-scroll space-x-8 sm:space-x-16 items-center py-4">
              ...
              <div className="flex space-x-8 sm:space-x-16 items-center min-w-max">
                <div className="flex items-center justify-center h-20 sm:h-28 w-32 sm:w-44">
                  <img src="/coca-cola-logo.png" alt="Coca Cola" className="h-16 sm:h-24 w-auto object-contain" />
                </div>
                <div className="flex items-center justify-center h-20 sm:h-28 w-32 sm:w-44">
                  <img
                    src="/ethio-telecom-logo.jpg"
                    alt="Ethio Telecom"
                ...
                <div className="flex items-center justify-center h-20 sm:h-28 w-32 sm:w-44">
                  <img
                    src="/abstract-ministry-logo.png"
                    alt="Ministry of Women"
                    className="h-16 sm:h-24 w-auto object-contain"
                  />
                </div>
                <div className="flex items-center justify-center h-20 sm:h-28 w-32 sm:w-44">
                  <img src="/alx-logo.jpg" alt="ALX" className="h-16 sm:h-24 w-auto object-contain" />
                </div>
                <div className="flex items-center justify-center h-20 sm:h-28 w-32 sm:w-44">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              ...
              <div className="bg-[#f1f0f0ff] text-[#414040ff] p-4 sm:p-6 rounded-b-2xl">
                ...
                <div className="flex items-center">
                  <div className="bg-transparent rounded px-2 sm:px-3 py-1 flex items-center">
                    <img src="/innohub-logo.jpg" alt="InnoHub" className="h-8 sm:h-10 w-auto" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="group cursor-pointer bg-[#f1f0f0ff] rounded-2xl transition-colors duration-300">
              <div className="relative mb-6">
                <div className="relative overflow-hidden rounded-t-2xl">
                  <img
                    src="/professional-business-man-executive.jpg"
                    alt="Michael Chen"
                    className="w-full h-64 sm:h-80 object-cover transition-transform duration-300 group-hover:scale-105"
                  />
                  <div className="absolute bottom-0 left-0 right-0 h-6 sm:h-8">
              ...
              <div className="bg-[#f1f0f0ff] text-[#414040ff] p-4 sm:p-6 rounded-b-2xl">
                ...
                <div className="flex items-center">
                  <div className="bg-transparent rounded px-2 sm:px-3 py-1 flex items-center">
                    <img src="/bluemoon-logo.jpg" alt="BlueMoon" className="h-6 sm:h-8 w-auto" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-[#f1f0f0ff] text-[#414040ff] p-4 sm:p-6 rounded-b-2xl">
                ...
                <div className="flex items-center">
                  <div className="bg-transparent px-2 sm:px-3 py-1 flex items-center">
                    <img src="/dangote-logo.jpg" alt="Dangote" className="h-6 sm:h-8 w-auto" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="group cursor-pointer bg-[#f1f0f0ff] rounded-2xl transition-colors duration-300">
              ...
              <div className="bg-[#f1f0f0ff] text-[#414040ff] p-4 sm:p-6 rounded-b-2xl">
                ...
                <div className="flex items-center">
                  <div className="bg-transparent rounded px-2 sm:px-3 py-1 flex items-center">
                    <img src="/hibret-bank-logo.jpg" alt="Hibret Bank" className="h-6 sm:h-8 w-auto" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="relative z-10 bg-black py-12 sm:py-20 overflow-hidden">
        <div className="absolute top-1/2 right-0 transform -translate-y-1/2 translate-x-1/4 pointer-events-none select-none hidden lg:block">
          <img
            src="/decorative-location-shape.jpg"
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="rounded-2xl overflow-hidden">
                <img
                  src="/addis-ababa-conference-center-interior-hall.jpg"
              ...
              <div className="mb-6 sm:mb-8">
                <div className="flex items-center space-x-2 mb-4 sm:mb-6">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-white rounded-full flex items-center justify-center">
                    <span className="text-blue-600 font-bold text-xl sm:text-2xl">A</span>
                  </div>
                  <span className="text-white font-bold text-xl sm:text-2xl">AIESEC YSF</span>
                </div>
